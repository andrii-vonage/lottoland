...
export const CampaignsList = ({ onStop, data, ...rest }: CampaignsListProps) => {
        ...
        () => [
            ...
            },
            {
                ...
                Cell: ({ cell }: CellProps<Campaign>) => (
                    <Badge colorScheme={cell.row.values.status === "Running" ? "green" : "red"}>
    ...
    return <CustomTable<Campaign> columns={columns} data={data} withPagination {...rest} />;
};
